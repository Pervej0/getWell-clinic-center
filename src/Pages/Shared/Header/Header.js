...
const Header = () => {
  ...
  return (
    <header>
      <nav className="flex items-center bg-blue-500 p-3 flex-wrap md:px-14">
        <NavLink
          to="/"
        ...
        >
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start flex flex-col lg:h-auto">
            ...
            {user ? (
              <>
                <div className="lg:inline-flex login lg:w-auto w-full px-3 py-2 rounded text-white items-center justify-center">
                  {!user.photoURL ? (
                ...
                <NavLink
                  to="/login"
                  onClick={logOut}
                  className="lg:inline-flex login lg:w-auto w-full px-3 py-2 rounded text-white items-center justify-center hover:text-gray-300 leading-4	 font-semibold"
                >
                  <span>Log Out</span>
                </NavLink>
              </>
